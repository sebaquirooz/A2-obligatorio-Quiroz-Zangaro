...
//Acá tenemos que hacer el hash abierto, o sea, la lista de nodos en cada bucket.

template <class K, class V> class hashA_table : public table<K, V> {
private:
  struct kv_pair {
    K key;
    V value;
...
public:
  hashA_table(int expectedSize, hash_func<K> *h) {
    this->h = h;
